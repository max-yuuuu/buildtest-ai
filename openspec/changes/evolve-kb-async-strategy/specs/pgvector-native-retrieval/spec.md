...
For `postgres_pgvector` knowledge bases, the system SHALL execute vector similarity search in PostgreSQL using pgvector-native operators and indexed vector columns, rather than in-memory Python similarity scoring.
